    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-[#2bffa0] selection:text-black font-sans overflow-x-hidden">
      ...
      <footer className="py-20 px-6 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row justify-between items-start gap-12 md:gap-8">
          ...
          {/* Colunas Direitas: Links Estruturados */}
          <div className="flex flex-col md:flex-row gap-12 md:gap-24 w-full md:w-auto text-center md:text-left">
             <div className="flex flex-col gap-4">
               ...
               <Link href="/manifesto" className="text-xs font-bold uppercase tracking-widest hover:text-[#2bffa0] text-white transition-colors">Nosso Manifesto</Link>
               <a href="https://www.instagram.com/novoflowdigital" target="_blank" className="text-xs font-bold uppercase tracking-widest hover:text-[#2bffa0] text-white transition-colors">Instagram</a>
               <a href="https://share.google/pLLiKYJLPaw2vygw1" target="_blank" className="text-xs font-bold uppercase tracking-widest hover:text-[#2bffa0] text-white transition-colors">Google</a>
             </div>

             <div className="flex flex-col gap-4">
               <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2">Programas</span>
               <a href="https://form.respondi.app/lDg0Bifo" target="_blank" className="text-xs font-bold uppercase tracking-widest hover:text-[#2bffa0] text-white transition-colors">
                 Ativar Minha Máquina
               </a>
             </div>
             ...
             <div className="flex flex-col gap-4">
               ...
               <a href="https://wa.me/5541984370981" target="_blank" className="text-sm font-black hover:text-[#2bffa0] text-white transition-colors">
                 (41) 98437-0981
               </a>
               <a 
                 href="https://share.google/pLLiKYJLPaw2vygw1" 
                 target="_blank" 
                 className="text-xs font-bold uppercase tracking-tight text-white mt-2 px-3 py-1.5 rounded transition-all duration-200 hover:bg-[#2bffa0] hover:text-white"
               >
                 Curitiba / PR - Brasil
               </a>
             </div>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a 
          ...
          target="_blank"
          className="flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-[0_4px_14px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform duration-300"
        >
